...
export default [
    {
        ...
        output: { file: 'dist/server/lance-gg.js', format: 'es', name: 'Server', sourcemap: true },
    ...
    },
    {
        ...
        input: 'src/package/serverExports.js',
        external: ['fs', 'bufferutil', 'utf-8-validate'],
        output: { file: 'dist/server-module/lance-gg.js', format: 'es', name: 'Server' },
        plugins: serverPlugins
    },
    {
        // client build transpiled
        input: 'src/package/clientExports.js',
        output: { file: 'dist/client/lance-gg.js', format: 'es', name: 'Client', sourcemap: true },
        plugins: [... clientPlugins, babel({ exclude: '**/node_modules/**' })]
    },
    {
        // client build non-transpiled with es2015 modules
        input: 'src/package/clientExports.js',
        output: { file: 'dist/client-module/lance-gg.js', format: 'es', name: 'Client' },
